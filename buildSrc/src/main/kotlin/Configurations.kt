...
object versions {
  ...
  object androidX {
    ...
    const val fragment = "1.9.0"
    const val startUp = "1.2.0"

    object view {
      const val constraintLayout = "2.2.2"
      const val material = "1.14.0"
      const val recyclerView = "1.4.0"
    }

    const val navigation = "2.10.0"
  ...
  const val moshiKotlin = "1.15.2"
  const val retrofit = "2.12.0"
  const val okHttpLoggingInterceptor = "5.5.0"
